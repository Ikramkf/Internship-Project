        ...
        <div className="grid md:grid-cols-2 gap-4 w-full py-2">
          ...
          <div className="flex flex-col py-2">
            ...
            <input
              ...
              name="upload"
            />
            <button className="bg-[#001b5e] text-gray-100 mt-2 w-full p-2 rounded-lg ">
              Upload
            </button>
            <label className=" uppercase text-sm py-5 ">
              Vous pouvez coisir une date pour une intervention{" "}
            </label>
            <input
              className="border-2 rounded-lg p-3 flex border-gray-300 "
              type="date"
